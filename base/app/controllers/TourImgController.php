...
class TourImgController extends BaseController
{
    ...
    public function listImages()
    {
        ...
        return $this->render('admin.tourimg.listImages', compact('images'));
    }
    ...
    public function createImage()
    {
        ...
        return $this->render('admin.tourimg.addImage', compact('tours'));
    }
    ...
    public function detailImage($id)
    {
        ...
        return $this->render('admin.tourimg.editImage', compact('detail', 'tours'));
    }
    ...
    public function editImage($id)
    {
        ...
        // Xử lý ảnh
        $imagePath = $_POST['old_image'] ?? $detail['image_path'];
        if (isset($_FILES['image_path']) && $_FILES['image_path']['error'] === UPLOAD_ERR_OK) {
            $fileTmp = $_FILES['image_path']['tmp_name'];
            $fileName = time() . '_' . basename($_FILES['image_path']['name']);
            $targetDir = 'public/src/img/tours/';
