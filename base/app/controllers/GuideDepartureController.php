...
class GuideDepartureController extends BaseController
{
    ...
    public function createDeparture()
    {
        ...
        $tours = $tourModel->getToursGroupedByCategory();
        $categories = TourModel::getCategories();
        $this->render("admin.departure.addDeparture", ['tours' => $tours, 'categories' => $categories]);
    }
    ...
    public function detailDeparture($id)
    {
        ...
        $tour = new TourModel();
        $tours = $tour->getToursGroupedByCategory();
        $categories = TourModel::getCategories();
        return $this->render('admin.departure.editDeparture', ['detail' => $detail, 'tours' => $tours, 'categories' => $categories]);
    }
