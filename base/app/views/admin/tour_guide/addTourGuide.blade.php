...
@section('title', 'Thêm Tour Guide')
@section('active-tour-guide', 'active')

@section('content')
<div class="page-header mb-4">
    <h1 class="text-white">Thêm Tour Guide</h1>
</div>

<div class="card-dark p-4">
    <form action="{{ route('post-tour-guide') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <select name="guide_id" class="form-select" required>
                ...
                @foreach($guides as $g)
                    <option value="{{ $g->id }}">{{ $g->fullname }} ({{ $g->account_name }})</option>
                @endforeach
            </select>
        </div>
        <div class="mb-3">
            ...
            <select name="role" class="form-select" required>
                ...
                <option value="assistant" selected>Phó đoàn (Assistant)</option>
