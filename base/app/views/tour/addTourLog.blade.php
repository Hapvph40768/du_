...
@section('content')
    ...
    <form action="{{route('post-tour-log')}}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="day_number" id="day_number">
        </div>
