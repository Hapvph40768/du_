...
@section('content')
    ...
    <div class="page-header mb-4 d-flex justify-content-between align-items-end">
        ...
        <div class="d-flex gap-3">
             <a href="{{ route('add-guide-tour-log') }}" class="btn btn-primary d-flex align-items-center gap-2 rounded-pill px-4 shadow-sm">
                ...
                <tbody>
                    @forelse($logs as $log)
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="btn-group">
                                    <a href="{{ route('detail-guide-tour-log/' . $log->id) }}" class="btn btn-sm btn-outline-info border-0">
